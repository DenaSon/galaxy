...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        //Setting Validation Translations
        'system_admin_email' => 'ایمیل مدیر سیستم',
        'system_debugger_email' => 'ایمیل عیب یاب سیستم',
        'stock_manager_email' => 'ایمیل مدیر انبار',
        'support_manager_email' => 'ایمیل مدیر تیکتینگ',
        'system_admin_phone' => 'تلفن مدیر سیستم',
        'stock_manager_phone' => 'تلفن مدیر انبار',
        'system_debugger_phone' => 'تلفن عیب یاب سیستم',
        'verify_sms_template' => 'قالب پیامک تاییدیه',
        'notify_sms_template' => 'قالب پیامک اعلان',
        'quantity_sms_template' => 'قالب پیامک موجودی',
        'max_image_size' => 'حداکثر اندازه تصویر',
        'log_on_off' => 'سیستم گزارش گیری',
