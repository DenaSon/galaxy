<div id="cartSidePenal" drawer-end
    ...
    <div class="flex items-center justify-between p-4 border-b border-slate-200 dark:border-zink-500">
        <div class="grow">
            <h5 class="mb-0 text-16">سبد خرید <span
    ...
    <div class="px-4 py-3 text-sm text-green-500 border border-transparent bg-green-50 dark:bg-green-400/20">
        <span class="font-bold underline">TAILWICK50</span> کد کوپن با موفقیت اعمال شد.
    </div>
    <div>
            ...
            <div class="flex flex-col gap-4">
                <div class="flex gap-2 product">
                    <div
                        ...
                        <img src="{{ asset('admin/assets/images/img-012.png') }}" alt="" class="h-8">
                    </div>
                    <div class="overflow-hidden grow">
                        ...
                        <a href="#!" class="transition-all duration-200 ease-linear hover:text-custom-500">
                            <h6 class="mb-1 text-15">تیشرت مردانه یقه نخی</h6>
                        </a>
                        <div class="flex items-center mb-3">
                            <h5 class="text-base product-price"> $<span>155.32</span></h5>
                            <div class="font-normal rtl:mr-1 ltr:ml-1 text-slate-500 dark:text-zink-200">(مد)</div>
                        </div>
                ...
                <div class="flex gap-2 product">
                    <div
                        class="flex items-center justify-center w-12 h-12 rounded-md bg-slate-100 shrink-0 dark:bg-zink-500">
                        <img src="{{ asset('admin/assets/images/img-03.png') }}" alt="" class="h-8">
                    </div>
                    <div class="overflow-hidden grow">
                        <div class="ltr:float-right rtl:float-left">
                            <button
                        ...
                        <a href="#!" class="transition-all duration-200 ease-linear hover:text-custom-500">
                            <h6 class="mb-1 text-15">مانند کیف دستی مشکی مسافرتی</h6>
                        </a>
                        <div class="flex items-center mb-3">
                            <h5 class="text-base product-price"> $<span>349.95</span></h5>
                            <div class="font-normal rtl:mr-1 ltr:ml-1 text-slate-400 dark:text-zink-200">(بار
                                مسافر)
                            </div>
                        </div>
                        <div class="flex items-center justify-between gap-3">
                ...
                <div class="flex gap-2 product">
                    <div
                        class="flex items-center justify-center w-12 h-12 rounded-md bg-slate-100 shrink-0 dark:bg-zink-500">
                        <img src="{{ asset('admin/assets/images/img-09.png') }}" alt="" class="h-8">
                    </div>
                    <div class="overflow-hidden grow">
                        <div class="ltr:float-right rtl:float-left">
                            <button
                        ...
                        <a href="#!" class="transition-all duration-200 ease-linear hover:text-custom-500">
                            <h6 class="mb-1 text-15">مردانه یقه گرد با چاپ بلیو</h6>
                        </a>
                        <div class="flex items-center mb-3">
                            <h5 class="text-base product-price">$<span>546.74</span></h5>
                            <div class="font-normal rtl:mr-1 ltr:ml-1 text-slate-400 dark:text-zink-200">(مد)</div>
                        </div>
                        <div class="flex items-center justify-between gap-3">
                            <div class="inline-flex text-center input-step">
                                <button type="button"
        ...
        <div class="p-4 border-t border-slate-200 dark:border-zink-500">
            ...
            <table class="w-full mb-3 ">
                ...
                <tr>
                    <td class="py-2">مجموع فرعی :</td>
                    <td class="text-right cart-subtotal">$2,847.55</td>
                </tr>
                <tr>
                    <td class="py-2">تخفیف <span class="text-muted">(TAILWICK50)</span>:</td>
                    <td class="text-right cart-discount">-$476.00</td>
                </tr>
                <tr>
                    <td class="py-2">هزینه حمل و نقل :</td>
                    <td class="text-right cart-shipping">$89.00</td>
                </tr>
                <tr>
                    <td class="py-2">مالیات تخمینی (12.5%) :</td>
                    <td class="text-right cart-tax">$70.62</td>
                </tr>
                <tr class="font-semibold">
                    <td class="py-2">مجموع :</td>
