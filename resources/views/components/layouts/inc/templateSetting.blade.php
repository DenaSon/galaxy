<div id="customizerButton" drawer-end
    ...
    <div class="flex justify-between p-4 border-b border-slate-200 dark:border-zink-500">
        <div class="grow">
            <h5 class="mb-1 text-16"> سفارشی ساز تم تیلویک</h5>
            <p class="font-normal text-slate-500 dark:text-zink-200">تم ها و طرح بندی های خود را انتخاب کنید و غیره</p>
        </div>
        <div class="shrink-0">
    ...
    <div class="h-full p-6 overflow-y-auto">
        <div>
            <h5 class="mb-3 underline capitalize text-15">طرح بندی را انتخاب کنید</h5>
            <div class="grid grid-cols-1 mb-5 gap-7 sm:grid-cols-2">
                <div class="relative">
                    ...
                    <h5 class="mt-2 text-center text-15">عمودی</h5>
                </div>
                ...
                <div class="relative">
                    ...
                    <h5 class="mt-2 text-center text-15">افقی</h5>
                </div>
            </div>
            ...
            <div id="semi-dark">
                <div class="flex items-center">
                    ...
                    <label for="customDefaultSwitch" class="inline-block text-base font-medium">نیمه تاریک (نوار کناری و
                        هدر)</label>
                </div>
            </div>
        </div>
        ...
        <div class="mt-6">
            <!-- data-skin="" -->
            <h5 class="mb-3 underline capitalize text-15">طرح بندی های پوسته</h5>
            <div class="grid grid-cols-1 mb-5 gap-7 sm:grid-cols-2">
                <div class="relative">
                    ...
                    <h5 class="mt-2 text-center text-15">پیش فرض</h5>
                </div>
                ...
                <div class="relative">
                    ...
                    <h5 class="mt-2 text-center text-15">حاشیه دار</h5>
                </div>
            </div>
        </div>
        ...
        <div class="mt-6">
            <!-- data-mode="" -->
            <h5 class="mb-3 underline capitalize text-15">روشن و تاریک</h5>
        ...
        <div class="mt-6">
            <!-- data-content -->
            <h5 class="mb-3 underline capitalize text-15">عرض محتوا</h5>
            <div class="flex gap-3">
        ...
        <div class="mt-6" id="sidebar-size">
            <!-- data-sidebar-size="" -->
            <h5 class="mb-3 underline capitalize text-15">اندازه نوار کناری</h5>
            <div class="flex flex-wrap gap-3">
        ...
        <div class="mt-6" id="navigation-type">
            <!-- data-navbar="" -->
            <h5 class="mb-3 underline capitalize text-15">نوع منو</h5>
            <div class="flex flex-wrap gap-3">
        ...
        <div class="mt-6" id="sidebar-color">
            ...
            <h5 class="mb-3 underline capitalize text-15">رنگ های نوار اندازه</h5>
            <div class="flex flex-wrap gap-3">
        ...
        <div class="mt-6">
            ...
            <h5 class="mb-3 underline capitalize text-15">رنگ های بار بالا</h5>
            <div class="flex flex-wrap gap-3">
