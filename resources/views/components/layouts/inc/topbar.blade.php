            ...
            <div
                ...
                <div
                    ...
                    <input type="text"
                           ...
                           placeholder="جستجو برای ..." autocomplete="off">
                ...
                <div class="flex gap-3 ms-auto">
                    <div class="relative flex items-center dropdown h-header">
                        <button type="button"
                            ...
                            <img src="{{ asset('admin/assets/images/ir.svg') }}" alt="" id="header-lang-img"
                        ...
                        <div
                            ...
                            <a href="#!" class="flex items-center gap-3 group/items language" data-lang="fa"
                               title="Persian">
                                <img src="{{ asset('admin/assets/images/ir.svg') }}" alt=""
                    ...
                    <div class="relative flex items-center dropdown h-header">
                        ...
                        <div
                            ...
                            <div class="p-4">
                                <h6 class="mb-4 text-16">نوتیفیکیشن ها <span
                                ...
                                <div class="flex flex-col gap-1" id="notification-list">
                                    <a href="#!"
                                       class="flex gap-3 p-4 product-item hover:bg-slate-50 dark:hover:bg-zink-500 follower">
                                        <div class="w-10 h-10 rounded-md shrink-0 bg-slate-100">
                                            <img src="{{ asset('admin/assets/images/avatar-7.png') }}" alt="" class="rounded-md">
                                        </div>
                                        <div class="grow">
                                            <h6 class="mb-1 font-medium"><b>@willie_passem</b> به دنبال شما</h6>
                                            <p class="mb-0 text-sm text-slate-500 dark:text-zink-300"><i
                                                    data-lucide="clock" class="inline-block w-3.5 h-3.5 mr-1"></i>
                                                <span class="align-middle">سه شنبه 03:42 PM</span></p>
                                        </div>
                                        <div
                                    ...
                                    <a href="#!"
                                       class="flex gap-3 p-4 product-item hover:bg-slate-50 dark:hover:bg-zink-500 mention">
                                        <div class="w-10 h-10 bg-yellow-100 rounded-md shrink-0">
                                            <img src="{{ asset('admin/assets/images/avatar-5.png') }}" alt="" class="rounded-md">
                                        </div>
                                        <div class="grow">
                                            <h6 class="mb-1 font-medium"><b>@caroline_jessica</b> در مورد پست شما
                                                نظر داد</h6>
                                            ...
                                            <div
                                                ...
                                                حیرت آور! سریع، به نقطه، حرفه ای و واقعا شگفت انگیز برای کار با
                                                آنها!!!
                                            </div>
                                        </div>
                                        <div
                                    ...
                                    <a href="#!"
                                       class="flex gap-3 p-4 product-item hover:bg-slate-50 dark:hover:bg-zink-500 invite">
                                        ...
                                        <div class="grow">
                                            <h6 class="mb-1 font-medium">با موفقیت یک طرح تجاری برای <span
                                                    class="text-red-500">$199.99</span></h6>
                                            <p class="mb-0 text-sm text-slate-500 dark:text-zink-300"><i
                                                    data-lucide="clock" class="inline-block w-3.5 h-3.5 mr-1"></i>
                                       ...
                                       class="flex gap-3 p-4 product-item hover:bg-slate-50 dark:hover:bg-zink-500 mention">
                                        <div class="relative shrink-0">
                                            <div class="w-10 h-10 bg-pink-100 rounded-md">
                                                <img src="{{ asset('admin/assets/images/avatar-7.png') }}" alt=""
                                                     class="rounded-md">
                                            </div>
                                        ...
                                        <div class="grow">
                                            <h6 class="mb-1 font-medium"><b>@scott</b> پست شما را پسندید</h6>
                                            <p class="mb-0 text-sm text-slate-500 dark:text-zink-300"><i
                                                    data-lucide="clock" class="inline-block w-3.5 h-3.5 mr-1"></i>
                                                <span class="align-middle">دوشنبه 06:59 AM</span></p>
                                        </div>
                                        <div
                                            class="flex items-center self-start gap-2 text-xs text-slate-500 shrink-0 dark:text-zink-300">
                                            <div class="w-1.5 h-1.5 bg-custom-500 rounded-full"></div>
                            ...
                            <div class="flex items-center gap-2 p-4 border-t border-slate-200 dark:border-zink-500">
                                ...
                                <div class="shrink-0">
                                    <button type="button"
                                        ...
                                        مشاهده همه نوتیفیکیشن ها <i data-lucide="move-right"
                                                                    class="inline-block w-3.5 h-3.5 ml-1"></i>
                                    </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="relative flex items-center dropdown h-header">
                        ...
                        <div
                            ...
                            <h6 class="mb-2 text-sm font-normal text-slate-500 dark:text-zink-300">به تیلویک خوش
                                آمدید</h6>
                            <a href="#!" class="flex gap-3 mb-3">
                                ...
                                <div>
                                    <h6 class="mb-1 text-15">مهدی نوری</h6>
                                    <p class="text-slate-500 dark:text-zink-300">مدیر عامل</p>
                                </div>
                            </a>
                            <ul>
                                <li>
                                ...
                                <li>
                                    <a class="block ltr:pr-4 rtl:pl-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:text-custom-500 focus:text-custom-500 dark:text-zink-200 dark:hover:text-custom-500 dark:focus:text-custom-500"
                                       href="pages-pricing.html"><i data-lucide="gem"
                                                                    class="inline-block size-4 ltr:mr-2 rtl:ml-2"></i>
                                        آپگرید <span
                                            class="inline-flex items-center justify-center w-auto h-5 ltr:ml-2 rtl:mr-2 px-1 text-[12px] font-medium border rounded text-white bg-sky-500 border-sky-500">مدیر</span></a>
                                </li>
