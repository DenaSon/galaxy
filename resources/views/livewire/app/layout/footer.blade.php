...
@endif">
    ...
    <footer class="footer bg-base-50 text-base-content mx-auto container">
        ...
        <nav>
            ...
            <a wire:navigate href="{{ route('home.singlePage',['page'=>2,'slug'=>'درباره-ما']) }}"
               class="link link-hover">درباره ما</a>

            <a wire:navigate href="{{ route('home.singlePage',['page'=>1,'slug'=>slugMaker('قوانین و مقررات')])  }}"
        ...
        <aside class="mb-10">
            ...
            <a href="{{ route('home.index-home') }}" wire:navigate>
                <img src="{{ asset('static/small-d-logo.png') }}" alt="LiftPal" width="100" height="45"
            ...
            <p>
                ...
                <span class="text-xs text-gray-500">
                    ...
                    <a title="تیم لیفت‌پال" class="link text-pink-800 tooltip" data-tip="ارتباط با طراح" target="_blank"
                       rel="nofollow noopener" href="https://wa.me/989173434796">تیم لیفت‌پال </a>
                </span>
