...
@endif
<!-- SEO Meta Tags -->
<meta name="description" content="{{ getSetting('meta_description') ?? 'liftpal is your trusted source for high-quality local souvenirs, nuts, and dried fruits. Discover the perfect mix for your taste!' }}" />
<meta name="keywords" content="{{ getSetting('meta_keywords') ?? 'souvenirs, nuts, dried fruits, local products, liftpal' }}" />
...
<meta property="og:description" content="{{ getSetting('meta_description') ?? 'Discover premium-quality local souvenirs, nuts, and dried fruits from liftpal.' }}" />
...
<meta name="twitter:description" content="{{ getSetting('meta_description') ?? 'Discover premium-quality local souvenirs, nuts, and dried fruits from liftpal.' }}" />
