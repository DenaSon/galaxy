<x-menu activate-by-route>
    ...
    <x-menu-sub title="بلاگ" icon="o-pencil-square">
        ...
        <x-menu-item title="ایجاد" icon="o-pencil" link="{{ config('APP_URL') }} }}/blogpress/wp-admin/post-new.php" external/>
        <x-menu-item title="لیست" icon="o-queue-list" link="{{ config('APP_URL')}}/blogpress/wp-admin/edit.php" external/>
        <x-menu-item title="پیشخوان" icon="o-book-open" link="{{ config('APP_URL') }}/blogpress/wp-admin/index.php" external/>
