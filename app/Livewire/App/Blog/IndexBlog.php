...
class IndexBlog extends Component
{
    ...
    public function render()
    {
        try {
            ...
            $response = Http::get('https://liftpal.ir/blogpress/wp-json/wp/v2/posts', $params);
            ...
            if ($response->successful()) {
                ...
                foreach ($blogs as &$blog) {
                    if (isset($blog['featured_media']) && $blog['featured_media']) {
                        $mediaResponse = Http::get('https://liftpal.ir/blogpress/wp-json/wp/v2/media/' . $blog['featured_media'], [
            ...
            $category_response = Http::get('https://liftpal.ir/blogpress/wp-json/wp/v2/categories?_fields=id,name,count');
            ...
            if ($this->category) {
                $category_name_url = 'https://liftpal.ir/blogpress/wp-json/wp/v2/categories/' . $this->category;
